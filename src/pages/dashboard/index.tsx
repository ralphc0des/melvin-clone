...
const Dashboard = () => {
  return (
    <div>
      ...
      <Tabs defaultValue="overview" className="space-y-4 my-10 px-10">
        <TabsList>
          <TabsTrigger value="overview">
            <Text className="small">Overview</Text>
          </TabsTrigger>
          <TabsTrigger value="analytics" disabled>
            <Text className="small">Analytics</Text>
          </TabsTrigger>
          <TabsTrigger value="reports" disabled>
            <Text className="small">Reports</Text>
          </TabsTrigger>
        </TabsList>
        <TabsContent value="overview" className="space-y-4">
          ...
          <div className="grid gap-4 lg:grid-cols-2 grid-cols-1">
            <Card className="lg:p-10 rounded-lg">
              <CardHeader>
                <CardTitle className="hidden lg:block">Overview</CardTitle>
              </CardHeader>
